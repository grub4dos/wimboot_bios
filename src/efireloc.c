                           ...
                           struct pe_relocs **pe_reltab)
{
  ...
  if (bfd_is_abs_section (sym->section))
  {
    ...
    if (strcmp (howto->name, "R_X86_64_64") == 0)
    {
      /* Generate an 8-byte PE relocation */
      generate_pe_reloc (pe_reltab, offset, 8);
    }
    else
      if ((strcmp (howto->name, "R_386_32") == 0) ||
          ...
          (strcmp (howto->name, "R_X86_64_32S") == 0))
      {
        ...
        if ((strcmp (howto->name, "R_386_16") == 0) ||
            (strcmp (howto->name, "R_X86_64_16") == 0))
        {
          ...
          if ((strcmp (howto->name, "R_386_PC32") == 0) ||
...
static void efireloc (const char *elf_name, const char *pe_name)
{
  ...
  if (nt->Pe32.FileHeader.Machine == EFI_IMAGE_MACHINE_IA32)
  {
    ...
    if (nt->Pe32Plus.FileHeader.Machine == EFI_IMAGE_MACHINE_X64)
    {
